...
import { CoreUserMainMenuHandler } from './services/handlers/mainmenu';
...
const mainMenuProfileRoutes: Routes = [
    {
        path: 'myprofile',
        loadChildren: () => import('@features/user/mainmenu-myprofile-lazy.module'),
    },
];
...
@NgModule({
    imports: [
        ...
        CoreMainMenuRoutingModule.forChild({ children: mainMenuProfileRoutes }),
    ...
    providers: [
        ...
        provideAppInitializer(() => {
            ...
            CoreMainMenuDelegate.registerHandler(CoreUserMainMenuHandler.instance);
